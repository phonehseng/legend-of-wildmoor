...
[download the retro game](../../legend_of_peanits_v3.1.1_retro.html) · [test notes](../QA_3.1_retro.md) · [the main build is unchanged](../../legend_of_peanits_v3.0.html)
...
- **texture warp** — 0 to 1. how much of the texture mapping ignores perspective, the playstation's affine swim. half on by default.

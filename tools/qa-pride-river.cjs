...
async function main(){
  const input=path.resolve(process.argv[2]||'legend_of_wildmoor_v3.8.3.html'),out=path.resolve(process.argv[3]||'artifacts/pride-river/final');fs.mkdirSync(out,{recursive:true});

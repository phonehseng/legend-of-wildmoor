...
async function main(){
  const input=path.resolve(process.argv[2]||'legend_of_wildmoor_v3.7.html'),out=path.resolve(process.argv[3]||'artifacts/pride-river/final');fs.mkdirSync(out,{recursive:true});

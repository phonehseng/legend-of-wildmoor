...
//
// defaults: legend_of_peanits_v3.3.1.html -> legend_of_peanits_v3.3.1_retro.html
const fs = require("fs");
const path = require("path");

const SRC = path.resolve(process.argv[2] || "legend_of_peanits_v3.3.1.html");
const OUT = path.resolve(process.argv[3] || "legend_of_peanits_v3.3.1_retro.html");
const VERSION = "3.3.1";

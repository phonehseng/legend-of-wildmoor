...
//
// defaults: legend_of_wildmoor_v3.8.3.html -> legend_of_wildmoor_v3.8.3_retro.html
const fs = require("fs");
const path = require("path");

const SRC = path.resolve(process.argv[2] || "legend_of_wildmoor_v3.8.3.html");
const OUT = path.resolve(process.argv[3] || "legend_of_wildmoor_v3.8.3_retro.html");
const VERSION = "3.8.3";

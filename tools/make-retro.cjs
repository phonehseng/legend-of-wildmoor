...
//
// defaults: legend_of_wildmoor_v3.6.2.html -> legend_of_wildmoor_v3.6.2_retro.html
const fs = require("fs");
const path = require("path");

const SRC = path.resolve(process.argv[2] || "legend_of_wildmoor_v3.6.2.html");
const OUT = path.resolve(process.argv[3] || "legend_of_wildmoor_v3.6.2_retro.html");
const VERSION = "3.6.2";

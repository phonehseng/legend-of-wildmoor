...
//
// defaults: legend_of_wildmoor_v3.8.4.html -> legend_of_wildmoor_v3.8.4_retro.html
const fs = require("fs");
const path = require("path");

const SRC = path.resolve(process.argv[2] || "legend_of_wildmoor_v3.8.4.html");
const OUT = path.resolve(process.argv[3] || "legend_of_wildmoor_v3.8.4_retro.html");
const VERSION = "3.8.4";

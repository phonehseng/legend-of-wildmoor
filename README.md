...
there is also a retro edition, the same game drawn the way a 1998 console drew it: [legend_of_peanits_v3.1.1_retro.html](legend_of_peanits_v3.1.1_retro.html) — [what it looks like](docs/updates/3.1_retro.md) · [its test notes](docs/QA_3.1_retro.md).
